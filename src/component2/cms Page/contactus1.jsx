...
export default function contactus1() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${baseUrl}get_ourMission_details_admin`,{
                headers: {
    ...
    const handleApi = async () => {
        try {
            const response = await axios.post(`${baseUrl}cms_our_mission`, {
                ...
                >
                    <div className='d-flex flex-column gap-2'>
                        <TextField
                            ...
                            label='Heading'
                            variant='outlined'
                            value={data1.Heading} // Set value of heading field
                        />
                        <TextField
                            id='outlined-basic'
                            style={{ width: '100%' }}
                            ...
                            variant='outlined'
                            margin='normal'
                            value={data1.Description} // Set value of description field
                        />
                        <Button
                            variant='contained'
                            onClick={handleApi}
                            style={{ backgroundColor: '#2b6166', color: '#ffffff', marginTop: '10px' }}
                        >
                            Submit
                        </Button>
                    </div>
